...
/**
 * @author gyw33188
 * @version $Id: Reactor.java, v0.1 2017/6/14 gyw33188 Exp $$
 */
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (selectionKey.isAcceptable()) {// 客户请求连接
                    ...
                    serverSocketChannel.accept().configureBlocking(false).register(in_selector, SelectionKey.OP_READ | SelectionKey.OP_WRITE).attach(id++);
